  ...
  return (
    <SafeAreaView style={{...styles.container, backgroundColor: '#84c4ab', position:'relative'}}>
      <View style={styles.centered}>
        <Text style={{...styles.title, marginTop: 50}}>REPORT CRISIS AND EMERGENCY</Text>
      </View>
      ...
      <View style={{alignItems: 'center', marginTop: 20, position: 'absolute', top: 0, left: 10}}>
        ...
        <Image source={require("../../assets/images/Chat Side Bar.png")} style={{width: '90%',
        height: '80%',
        resizeMode: 'contain', position: 'absolute', top: 120, left: -130}} />
    </SafeAreaView>
  );
}
